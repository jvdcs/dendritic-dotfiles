-- Custom colorscheme, ported exactly from a Helix theme.
-- Pure highlight-group definitions only -- non-color options (ruler,
-- statusline, termguicolors) live in core/options.lua.
